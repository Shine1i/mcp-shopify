...
const getInventoryLevels = {
    ...
    execute: async (input) => {
      ...
      `;
            ...
            const inventoryLevels = data.inventoryLevels.edges.map((edge) => {
            ...
            throw new Error(`Failed to fetch inventory levels: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
};
export { getInventoryLevels };
//# sourceMappingURL=getInventoryLevels.js.map